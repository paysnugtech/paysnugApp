...
use App\Interfaces\Services\IDataBeneficiaryService;
...
class DataBeneficiaryService implements IDataBeneficiaryService
{
    use EmailTrait,
    ...
    public function list()
    {
        ...
        $beneficiaries = $this->dataBeneficiaryRepository->fetchAll();
    ...
    public function getBeneficiary($id)
    {
        ...
        $beneficiaries = $this->dataBeneficiaryRepository->fetch($id);
    ...
    public function getBeneficiaryByPhoneNo($phone_no)
    {
        ...
        $beneficiaries = $this->dataBeneficiaryRepository->fetchByPhoneNo($phone_no);
    ...
    public function getBeneficiaryByUserId($user_id)
    {
        ...
        $beneficiaries = $this->dataBeneficiaryRepository->fetchByUserId($user_id);
    ...
    public function getBeneficiaryByPhoneNoUserId($phone_no, $user_id)
    {
        ...
        $beneficiaries = $this->dataBeneficiaryRepository->fetchByPhoneNoUserId($phone_no, $user_id);
